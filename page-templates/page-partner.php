...
<div id="particles-js" style="background-image: url('<?php bloginfo('template_url') ?>/assets/images/handshake.png')">
   ...
   <div class="flip-container-partner">
           <div class="card-partner">
                <a href ="http://localhost/boomslang/microsoft/"><div class="front-partner">
                   <p style="font-size:30px;color:#FFFFFF;">Read More <i class="fas fa-chevron-right"></i></p>
               </div></a>
